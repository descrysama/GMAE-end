...
<header>
    ...
    <main>
      <div class="d-flex justify-content-center">
          <img src="../assets/img/ALLIA.png" alt="ALLIA" width="15%">
      </div>
      <div class="container">
        <div class="row">
        ...
        <p>ALLIA accompagne les entreprises dans leurs démarches en terme d’assurance. 
        ...
        <div class="container">
            <div class="row">
                ...
                <form method="POST" action="sendpost">
                        <input type="hidden" name="assurance_id" value="2">
                    ...
                    <div id="commentaires">
                      <?php 
                            ...
                            $req = $bdd->prepare("SELECT * FROM comments WHERE assurance_id = 2");
                            $req->execute();
